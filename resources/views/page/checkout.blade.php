                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-block">
                            ...
                            <input id="gender" type="radio" class="input-radio"
                                   name="gender" value="nam" checked="checked"
                                   style="width: 10%"><span
                    ...
                    <div class="col-sm-6">
                        <div class="your-order">
                            <div class="your-order-head"><h5>Đơn hàng của
                                    bạn</h5></div>
                            <div class="your-order-body"
                                            ...
                                            @foreach($product_cart as $product)
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span class="color-gray your-order-info">Price: @if($product['item']['promotion_price'] == 0)                                                       {{number_format($product['item']['unit_price'])}}
                                                            @else
                                                                {{number_format($product['item']['promotion_price'])}}
                                                            @endif VNĐ</span>
                                                        <span class="color-gray your-order-info">Quantity: {{$product['quantity']}}</span>
                                                    </div>
                                                </div>
                                            @endforeach
                                        @endif
                                ...
                                <div class="your-order-item">
                                    <div class="pull-left"><p
                                                class="your-order-f18">Tổng
                                            tiền:</p></div>
                                    <div class="pull-right"><h5
                                                class="color-black">{{$totalPrice}} VNĐ</h5>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <div class="your-order-head"><h5>Hình thức thanh
                                    toán</h5></div>
                                ...
                                <ul class="payment_methods methods">
                                    ...
                                    <li class="payment_method_cheque">
                                        <input id="payment_method_cheque"
                                               ...
                                               data-order_button_text="">
                                        <label for="payment_method_cheque">Chuyển
                                            khoản </label>
